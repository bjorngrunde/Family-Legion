class Setting::SettingsController < ApplicationController
  ...
  def change_password
    ...
    return render cell(Familylegion::Cell::Setting, result["model"], context: { cell_view: "Setting::Cell::ChangePassword", current_user: current_user, form: result["contract.default"] }) if result.success?
  end
